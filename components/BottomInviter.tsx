...
export default function BottomInviter() {
  return (
    <div className="bg-black w-full flex flex-col justify-center items-center gap-10 pt-[10rem] ">
      <h1 className="w-2/3 leading-[7rem] text-[8rem] font-bold text-center">
        Accelerate your workflow.
      </h1>
      <p className="text-[2rem] text-dark-text">
        Try it for yourself! Start coding for free and upgrade anytime.
      </p>
      <div className="hover:underline cursor-pointer flex justify-center items-center gap-3 text-[2rem]">
